...
class DeviceConnection:
    ...
    def connect(self):
        """Connects to the device and logs in if credentials are provided."""
        self.transport = TCPTransport() if self.port == DeviceConnection.TCP_PORT else UDPTransport()
        self.router = RouterClient(self.transport, RouterClient.basicErrorCallback)
    ...
    def disconnect(self):
        """Disconnects and logs out from the device."""
