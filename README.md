...
> *Robot Camera Calibration*: robo-cam-calib

Package repository for Robot Camera Calibration: Repo for calibrating robot cameras.
...
```bash
git clone https://github.com/kevin-thankyou-lin/robo-cam-calib
cd robo-cam-calib
pip install -e .
```
...
+ `robo-cam-calib` - Package source code; has all core utilities for model specification, loading,
                               preprocessing, etc.
